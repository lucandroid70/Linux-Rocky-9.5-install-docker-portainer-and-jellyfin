# Docker Stack per Rocky Linux 9.5
Creata da Luca Sabato 
Script per installare automaticamente Docker, Portainer e Jellyfin (con FFmpeg) su Rocky Linux 9.5.

## 📋 Prerequisiti
- Server Rocky Linux 9.5 (minimal install)
...
# Installa nano e bash-completion
sudo dnf install -y nano bash-completion
...
chmod +x install_docker_stack.sh


sudo ./install_docker_stack.sh
